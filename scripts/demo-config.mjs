...
console.log(`AGENT_KEY=                 # generated: node worker/scripts/gen-agent-key.mjs`)
console.log(`INTERNAL_AGENT_TICK_TOKEN=dev-tick-token`)
console.log(`RESCUEGRID_DEMO_MODE=true`)
console.log(`EXECUTION_ENABLED=false    # flip to true only once the BalanceManager holds DBUSDC`)
