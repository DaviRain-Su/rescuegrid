...
console.log(`\nRun:  (worker) cd worker && npm i && npm run dev -- --port 8787`)
console.log(`      (web)    npm i && npm run dev -- --host localhost --port 5175`)
console.log(`      (smoke)  RESCUEGRID_FRONTEND_URL=http://localhost:5175 RESCUEGRID_WORKER_URL=http://localhost:8787 npm run baseline:smoke`)
console.log(line)
