...
- **Risk center** — global budget, strategy controls, Sui venue caps, liquidation/oracle/signer health, stale-data warnings, Guardian rule simulation, and global / strategy / venue emergency-stop surfaces.
