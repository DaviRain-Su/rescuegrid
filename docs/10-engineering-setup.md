...
| Frontend wallet and transaction UX | `frontend-apps` | dApp Kit wallet connect, wallet-signed create/revoke flows, zkLogin optional path | `npm run build`, `npm run test:live-config`, `npm run test:signer-health` |
