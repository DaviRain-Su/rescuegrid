...

{
  ...
  assert.equal(report.funding_targets.balance_manager.target_kind, 'deepbook_balance_manager')
  assert.equal(report.funding_targets.balance_manager.direct_wallet_transfer_accepted, false)
  assert.equal(report.funding_targets.balance_manager.required_assets[0].target, DEPLOYMENT.agent.balance_manager_id)
  assert.equal(report.funding_targets.balance_manager.required_assets[0].direct_wallet_transfer_accepted, false)
  assert.equal(report.funding_targets.agent_gas.target_kind, 'agent_gas_address')
  assert.equal(report.funding_targets.agent_gas.required_assets[0].target, DEPLOYMENT.agent.address)
  assert.equal(report.funding_targets.agent_gas.required_assets[0].direct_wallet_transfer_accepted, true)
