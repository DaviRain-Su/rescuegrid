...
export default function App({ onExit }) {
  ...
  const titles = {
    ...
    markets: { t: 'Sui markets monitor', s: 'DeepBook spreads, Cetus LP, Sui lending and Bluefin hedge signals' },
    strategies: { t: 'Strategy catalog', s: 'Policy-constrained Sui strategy templates' },
                ...
                <>
                  ...
                  <div className="card fade-up" style={{ position: 'absolute', top: 44, right: 0, width: 320, zIndex: 61, padding: 0, overflow: 'hidden', boxShadow: 'var(--popover-shadow)' }}>
                    ...
                    <div style={{ maxHeight: 320, overflowY: 'auto' }}>
                      {notifs.map(n => {
                        const nm = { exec: ['var(--accent)', 'bolt'], rebalance: ['var(--sui)', 'swap'], guardian: ['var(--danger)', 'shield'], retry: ['var(--warn)', 'refresh'], policy: ['var(--sui)', 'grid'] }[n.kind] || ['var(--t1)', 'eye']
                        return (
